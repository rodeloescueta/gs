                  ...
                  <div className="relative h-[242px]">
                      ...
                      <div className="flex w-[33%] flex-col gap-[52px] pb-5 md:w-full sm:gap-[26px]">
                        ...
                        <div className="pb-[21px] sm:pb-5">
                          ...
                          >
                            ...
                            agency aan. We brengen voortdurend nieuwe ideeën tot
                            leven, waarbij we de grenzen van creativiteit en
                      ...
                      <div className="flex w-[33%] flex-col justify-center gap-[52px] pb-[17px] md:w-full sm:gap-[26px]">
                        ...
                        <div className="mb-1 pr-[17px]">
                          <Text
                            ...
                            className="leading-[21px] tracking-[-0.30px]"
                          >
                            In een wereld die voortdurend verandert, blijft ons
                            agency niet achter. We zijn niet alleen voorbereid
                            op verandering, we verwelkomen het. Onze aanpak is
                            altijd fris, vooruitstrevend en afgestemd op de
                            toekomst.
                          </Text>
                        </div>
                      </div>
                    ...
                    <div className="absolute bottom-[0.00px] right-[-0.54px] m-auto flex w-[32%] justify-center pr-[18px]">
                      ...
                      >
                        ...
                        makkelijk te begrijpen zijn. Dingen helder maken is echt
                        een kunst en wij zijn er dol op. Of het nu gaat om een
                        verhaal over een merk of het ontwerp van een website.
                      </Text>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between gap-5 border-t border-solid border-blue_gray-100_01 pt-[38px] md:flex-col sm:pt-5">
              ...
              <div className="flex self-end">
                <Text as="p" className="tracking-[-0.30px] !text-gray-900">
                  Grandsolution is een digital agency met strategen, ontwerpers
                  en ontwikkelaars. Wij combineren onze expertise om
                  verwachtingen te overtreffen en bedrijven te helpen groeien.
                </Text>
              </div>
            </div>
          </div>
